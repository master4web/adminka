function createjsDOMenu() {
  ...
  with (absoluteMenu2) {
    addMenuItem(new menuItem("Статьи", "", script + '?admin=news'));
	addMenuItem(new menuItem("Новости", "", script + '?admin=news_lite'));
	addMenuItem(new menuItem("Авторы", "", script + '?admin=authors'));
	addMenuItem(new menuItem("Опросы", "", script + '?admin=votes_news'));
	addMenuItem(new menuItem("-"));
	addMenuItem(new menuItem("Темы", "", script+'?admin=subject'));
	addMenuItem(new menuItem("-"));
